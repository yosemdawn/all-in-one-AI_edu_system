这套系统前端是开源的 本人烧上亿token把后端差不多补完了!!

本人三个月吐血制作!!!(本人0基础小白)
测试网址 http://yosem.vip

--(2024.4.21 服务器到期了 网站访问不了 等我续一个重新部署)---
...
作业发布太复杂 我还没想好怎么改 因为我想的是老师可以上传题目 然后LLM根据这个题目进行批阅

但考虑到有的可能连题带答案一起传 所以这个步骤就没必要了 

要是能在发布的时候可以选作业类型就好了。。。(制作中)
